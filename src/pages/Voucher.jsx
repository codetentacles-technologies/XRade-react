...
const [isPopupOpen, setIsPopupOpen] = useState(false);
    ...
    return (
        ...
        <div className='container text-primary overflow-auto h-auto'>
            <BreadCrumbs title="Voucher" breadcrumbs={breadcrumbs} />
            <div className='flex flex-col items-center justify-center h-page'>
                <div className='flex flex-col items-center justify-center mx-auto gap-[74px] h-min bg-bluegradient text-white p-[32px] rounded-2xl w-full md:w-2/3 lg:w-1/2'>
