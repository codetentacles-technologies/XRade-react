...
const Dashboard = () => {
  ...
  // Ensure chainId is valid and exists in blockConfig
  const config = blockConfig[chainId] || blockConfig[Object.keys(blockConfig)[0]];
  ...
  const {
    ...
    abi: config.XRADE_ABI,
    address: config.XRADE_ADDRESS,
    functionName: "plans",
    args: [1],
  });
      ...
      <div className="flex flex-col gap-[94px]">
        <div className="flex flex-col gap-[36px]">
          <div className="" data-aos="fade-up">
            ...
            <p className="text-lightblue pt-2 ">
          ...
          <div className="p-4 px-6 border rounded-[24px] lg:w-1/2" data-aos="fade-up">
            ...
            <p className="flex items-center gap-3 text-lg font-bold text-primary text-wrap break-all">https://howard.codetentaclestechnologies.tech/register?ref=1 <span className="bg-homeabout rounded-[4px] p-2 ml-2"><svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* graph section */}
          <div>
            <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 gap-8" data-aos="fade-up">
              <div className="xl:col-span-2">
                <img src="/images/graph-img.webp" alt="graph" className="rounded-3xl shadow-md" />
              </div>
              <div className="flex flex-col lg:flex-row xl:flex-col gap-8 w-full">
                <img src="/images/active-graph.webp" alt="active-graph" className="rounded-[10px] shadow-md" />
                <img src="/images/source-graph.webp" alt="source-graph" className="rounded-[10px] shadow-md" />
              </div>
            </div>
          </div>
        </div>
