        ...
        <div className='bg-header mx-auto fixed top-0 left-0 w-full z-10'>
            <header className="flex items-center justify-between py-4 container">
               <Link to="/"> <img src="/images/Xtrade-logo.webp" alt="" className='w-[54px]' /></Link>
                ...
                <button className="bg-blue text-white text-sm lg:text-lg font-bold py-3 px-8 rounded-full flex items-center gap-2 hover:bg-bluegradient"> <img src="/images/connect-wallet-img.webp" alt="wallet" className='w-[18px] h-[18px]' />Connect Wallet</button>
            </header>
        </div>
    )
}
