            ...
            <div className='flex flex-col justify-center items-center gap-9 py-8 px-4 mx-auto  max-w-full sm:max-w-[540px] md:max-w-[680px] lg:max-w-[900px] xl:max-w-[1200px]' >
                <div className="flex flex-col lg:flex-row gap-4 items-center justify-between w-full ">
                    ...
                    <div className='flex flex-col items-center justify-center gap-4'>
                        <p className='text-base text-secondary font-medium'>Social Media Links </p>
                        <div className='flex items-center justify-center gap-6'>
                            <Facebook color='#ffffff' fill='#ffffff' className='bg-primary p-1 rounded-[4px] w-[24px] h-[24px]'/>
                            <Linkedin color='#ffffff' fill='#ffffff' className='bg-primary p-1 rounded-[4px] w-[24px] h-[24px]'/>
                            <Twitter color='#28418D' fill='#28418D'/>
                        </div>
                    </div>
                </div>
                <div>
                    <p className='text-sm text-primary font-normal'>@XTrade 2024. All right reserved</p>
                </div>
            </div>
        </div>
    )
